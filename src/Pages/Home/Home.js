  ...
  return (
    <div>
      ...
      <div className="totalDescription mt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="leftSide grid grid-cols-1 md:grid-cols-2 gap-4 rounded-xl shadow-inner bg-slate-200 ">
          ...
          <div className="leftContent flex flex-col justify-around align-middle p-2">
            ...
            <p className="font-bold">
              Web Design and Development Complete Guide to Becoming a Successful
              Freelancer
            </p>
      ...
      <div className="collapseHome mt-10 mb-32">
        ...
        <div className="totalCollapse grid grid-cols-2 gap-6 w-[95%] mx-auto mt-9 bg-teal-100 p-10">
