...
const Header = () => {
  ...
  return (
    <div className="navbarTop sticky top-0 z-10">
      <div className="navbar navbarDown w-[95%] mx-auto font-bold">
        ...
        <label
          className="swap swap-rotate w-[20px] ml-3 "
          onClick={() => toggleTheme()}
        >
          {/* <!-- this hidden checkbox controls the state --> */}
          ...
          {/* <!-- sun icon --> */}
          <svg
            className="swap-on fill-current w-7 h-7 text-slate-200"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
            <path
